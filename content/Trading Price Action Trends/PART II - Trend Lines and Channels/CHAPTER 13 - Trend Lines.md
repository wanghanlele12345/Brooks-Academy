---
title: "Chapter 13: Trend Lines"
sidebar:
  order: 19
---

> [!abstract] 核心逻辑
> **趋势线 (Trend Line, TL)** 是市场动能的边界。
> *   **顺势交易：** 在趋势线未被有效突破前，每一次触及都是顺势入场的机会。
> *   **反转逻辑：** 趋势线的突破是趋势减弱的**第一个信号**，但这并不意味着反转。市场通常需要**回测极值 (Test of Extreme)**（形成双顶/双底或更低高点/更高低点）后，才真正反转。
> *   **大多数突破会失败：** 强劲动能冲击趋势线时，新手认为是反转，老手认为是陷阱（Buy/Sell Vacuum）。
...
### 绘制原则
*   **Bull Trend Line:** 连接上涨趋势中的**低点**。
*   **Bear Trend Line:** 连接下跌趋势中的**高点**。
*   **Best Fit:** 不需要精确连接每一个点，使用“最佳拟合”或忽略影线（尤其在楔形中）。
*   **动态调整：** 随着趋势发展，原来的趋势线会被打破，需要根据新的摆动点绘制斜率更平缓的新线。

### 交易原则
*   **买入点：** 在多头趋势中，价格回调至趋势线附近（Undershoot/Overshoot 均可），出现反转信号时买入。
*   **假突破原理：** 当价格以极强动能冲向趋势线时（例如急跌至多头趋势线），这通常是**买入真空 (Buy Vacuum)**。
    *   新手：看到大阴线认为是反转，在趋势线附近做空。
    *   老手：在趋势线附近挂限价单买入，赌突破失败。
...
### 突破的意义
1.  **动能丧失：** 趋势线被打破是买卖双方力量平衡改变的第一个信号。
2.  **演变路径：**
    *   **Trend Continuation:** 测试趋势线后继续原有趋势（加速）。
    *   **Trading Range:** 突破后进入震荡。
    *   **Reversal:** 突破 -> 回测极值 (Test Extreme) -> 反向趋势。

### 再次测试 (Repeated Tests)
*   **现象：** 市场在短时间内多次（如15次）测试趋势线，且无法远离。
*   **结果 A (常见):** 最终突破趋势线并反转。
*   **结果 B (加速):** 市场放弃突破尝试，反而加速远离趋势线（趋势加速）。
...
*   **Parallel Lines:** 
    *   可以基于趋势通道线 (TCL) 创建平行线，平移至价格另一侧形成趋势线。
    *   主要用于识别通道的潜在边界。
*   **Dueling Lines (决斗线):**
    *   当回调通道的 TCL 与主趋势的 TL 相交时，该区域通常是强支撑/阻力位。
...
*   **Bar D Breakout:** 
    *   基于 Bar 3 和 15 高点的趋势线定义了通道顶部。
    *   Bar D 强力突破并伴随 Follow-through，确认了从下降通道向多头趋势的转换。