...
*   **测试原则**: 大多数高潮反转后的 Spike 都会被测试。
    *   Bear Market V Bottom -> 通常会回踩形成 **Higher Low** 或 **Double Bottom**。
    *   Bull Market V Top -> 通常会反弹形成 **Lower High** 或 **Double Top**。

#### c. 交易者方程 (Trader's Equation)

| 场景 | 信号特征 | 概率 | 建议策略 |
| :--- | :--- | :--- | :--- |
| **First Climax** | 第一次出现大 K 线 | 低 | **Fade**. 逆势做单胜率极低，大概率是 Measuring Gap。 |
| **Consecutive Climaxes** | 连续 2-3 个高潮，伴随 Wedge | 中 | **Wait**. 等待反向 Spike 出现后再入场。 |
| **Reversal Spike** | 出现强力的反向 K 线 | 高 | **Swing**. 止损设在 Spike 极值外，目标 10+ Bars。 |
...
![[Images/nc04f002.jpg]] ![[Images/nc04f003.jpg]]
